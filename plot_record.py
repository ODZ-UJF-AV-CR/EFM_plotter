...
with open('EFM_log_20240626_185029_UTC.csv', 'r') as file:
    data = []
    for line in file:
...
angle_index = (angle_index / max_length) * 360
...
l1 = ax1.plot(dates, angle_index, '.', color='red', alpha=0.1, label='Max value angle')
